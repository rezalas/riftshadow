...
#include "moremagic.h"
#include "interp.h"
#include "characterClasses/druid.h"
#include "cabal.h"
#include "characterClasses/healer.h"
...
{
	//	type			  name
	{	write_persisted(ITEM_LIGHT),		  "light"		},
	{	write_persisted(ITEM_SCROLL),	  "scroll"		},
	{	write_persisted(ITEM_WAND),		  "wand"		},
	{	write_persisted(ITEM_STAFF),		  "staff"		},
	{	write_persisted(ITEM_WEAPON),	  "weapon"		},
	{	write_persisted(ITEM_NULL6),		  "null6"		},
	{	write_persisted(ITEM_DICE),		  "dice" 		},
	{	write_persisted(ITEM_STONE),		  "stone"		},
	{	write_persisted(ITEM_TREASURE),	  "treasure"	},
	{	write_persisted(ITEM_ARMOR),		  "armor"		},
	{	write_persisted(ITEM_POTION),	  "potion"		},
	{	write_persisted(ITEM_CLOTHING),	  "clothing"	},
	{	write_persisted(ITEM_FURNITURE),	  "furniture"	},
	{	write_persisted(ITEM_TRASH),		  "trash"		},
	{	write_persisted(ITEM_CONTAINER),	  "container"	},
	{	write_persisted(ITEM_DRINK_CON),   "drink"		},
	{	write_persisted(ITEM_KEY),		  "key"			},
	{	write_persisted(ITEM_FOOD),		  "food"		},
	{	write_persisted(ITEM_MONEY),		  "money"		},
	{	write_persisted(ITEM_BOAT),		  "boat"		},
	{	write_persisted(ITEM_CORPSE_NPC),  "npc_corpse"	},
	{	write_persisted(ITEM_CORPSE_PC),	  "pc_corpse"	},
	{	write_persisted(ITEM_FOUNTAIN),	  "fountain"	},
	{	write_persisted(ITEM_PILL),		  "pill"		},
	{	write_persisted(ITEM_PROTECT),	  "protect"		},
	{	write_persisted(ITEM_MAP),		  "map"			},
	{	write_persisted(ITEM_PORTAL),	  "portal"		},
	{	write_persisted(ITEM_WARP_STONE),  "warp_stone"	},
	{	write_persisted(ITEM_ROOM_KEY),	  "room_key"	},
	{	write_persisted(ITEM_GEM),		  "gem"			},
	{	write_persisted(ITEM_JEWELRY),	  "jewelry"		},
	{	write_persisted(ITEM_SKELETON),	  "skeleton"	},
	{	write_persisted(ITEM_URN),		  "urn"			},
	{	write_persisted(ITEM_GRAVITYWELL), "gravitywell" },
	{	write_persisted(ITEM_BOOK),		  "book"		},
	{	write_persisted(ITEM_PEN),		  "pen"			},
	{	write_persisted(ITEM_ALTAR),		  "altar"		},
	{	write_persisted(ITEM_CAMPFIRE),	  "campfire"	},
	{	0,				  nullptr		}
};
...
{
	//	name, skill_level
	//	spell_fun, target, minimum_position,
	//	pgsn, dispel, min_mana, beasts
	//	noun_damage, msg_off, room_msg_off, ctype
	...
	},
	{
		...
		"curse", "The curse wears off.", "$n is no longer impure.", CMD_BOTH
	},
	{
	...
	},
	{
		...
		"", "You feel less aware of your surroundings.", "", CMD_NONE
	},
	{
		"detect movement", { 60, 53, 15, 53, 53, 53, 53, 53, 53, 53, 53, 53 },
		spell_null, TAR_IGNORE, POS_STANDING,
		&gsn_detect_movement, 0, 5, 12,
		"", "You slowly stop listening to your surroundings.", "", CMD_NONE
	},
	{
		"bluff", { 60, 53, 38, 53, 53, 53, 53, 53, 53, 53, 53, 53 },
		spell_null, TAR_IGNORE, POS_STANDING,
		&gsn_bluff, 0, 25, 12,
		"", "Your blood begins to dry up and your true wounds show through.", "", CMD_NONE
	},
	{
		"false motives", { 60, 53, 47, 53, 53, 53, 53, 53, 53, 53, 53, 53 },
		spell_null, TAR_IGNORE, POS_STANDING,
		&gsn_false_motives, 0, 25, 12,
		"", "You begin acting like yourself again.", "", CMD_NONE
	},
	{
	...
	},
	{
		...
		"faerie fire", "The pink aura around you fades away.", "The pink aura around $n fades away.", CMD_BOTH
	},
	{
	...
	},
	{
		...
		"", "You are no longer invisible.", "$n fades into view.", CMD_SPELL
	},
	{
	...
	},
	{
		...
		"", "The protective aura around your body fades.", "The protective aura around $n's body fades.", CMD_BOTH
	},
	{
		"shield", { 60, 53, 53, 53, 53, 53, 27, 53, 25, 15, 53, 53 },
		spell_shield, TAR_CHAR_SELF, POS_STANDING,
		&gsn_shield, CAN_DISPEL|CAN_CANCEL, 12, 12,
		"", "Your force shield shimmers then fades away.", "", CMD_BOTH
	},
	{
	...
	*/
	...
	},
	{
		...
		spell_null, TAR_IGNORE, POS_STANDING, 
		&gsn_request, 0, 0, 0,
		"", "Your contemplation of the good you have seen is over.", "", CMD_NONE
	},
	{
	...
	{
		"earthbind", { 60, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53 },
	...
	*/
	...
	},
	{
		...
		"", "Your senses of changes in water subside.", "", CMD_SPELL
	},
	{
	...
	},
	{
		...
		"shattered skin", "Your skin softens and returns to its normal state.", "", CMD_SPELL
	},
	{
	...
	},
	{
		...
		"", "The cooling mist surrounding you dissipates.", "The cooling mist surrounding $n dissipates.", CMD_SPELL
	},
	{
	...
	},
	{
		...
		"", "You feel ready to call upon the essence of plasma once again.", "", CMD_SPELL
	},
	{
...

	{
		...
		"", "The lingering effects of your unholy communion fade away.", "", CMD_SPELL
	},
	{
	...
	},
	{
		...
		"", "The smouldering anger within your dark heart fades.", "", CMD_SPELL
	},
	{
...
const struct group_type group_table [MAX_GROUP] =
{
	...
	},
	{
		"skirmisher",
		{ 
			"evasion", "hurl", "dart", "fifth attack", "entwine", "pull", "whirlwind"
		}
	},
	{
		"dragoon", 
	...
	},
	{
		"tactician",
		{ 
			"leadership", "assess", "exploit", "analyze", "terrain mastery", "outflank"
		},
	},
	...
	},
	{
		"acid",
		{
			"acid stream", "acid vein", "corrode lock", "neutralize", "caustic vapor"
		},
	},
	{
		"smoke",
	...
	},
	{
		"ice",
		{
			"glaciate", "stalactites", "ice blast", "hailstorm", "sheath of ice", "icy carapace"
		}
	},
	{
		"mist",
		{
			"vigorize", "cloak of mist", "rust", "cooling mist", "airy water", "prismatic spray"
		}
	},
	{
		"metal",
		{
			"alter metal", "fortify armor", "fortify weapon", "burden", "ironskin", "metal shards"
		}
	},
	{
		"ooze",
		{
			"sap endurance", "quicksand", "creeping tomb", "pass without trace", "emulsify"
		}
	},
	{
		"end",
