...
// extern void spell_hand_of_vengeance(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_earthquake(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_floating_disc(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_infernal_aid(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_fortitude(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_spiritblade(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_regenerate(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_decoy(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_decay_corpse(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_life_transfer(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_power_word_stun(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_trace(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_flame_scorch(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_soulbind(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_globe_of_darkness(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_drain(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_slave_of_purgatory(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);	/* Spell for Ancient Only -Detlef */
// extern void spell_mental_knife(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);			/* Spell for Kyr's tattoo -Dio */
// extern void spell_unholy_bless(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_confuse(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);				/* Confuse for Outlaw -Detlef */
// extern void spell_scrying(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_nova(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_randomizer(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_dark_shade(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);			/* for ancient --dioxide */
// extern void spell_lightwalk(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_tsunami(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_familiar(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_fire_and_ice(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_lifeline(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_shadowself(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_true_sight(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_guard_call(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_call_slayer(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_acid_spit(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_unholy_fire(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_general_purpose(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_nexus(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
// extern void spell_portal(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
...
void spell_hold_person(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);			/* Hold person -Detlef */
void spell_crushing_hand(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);
void spell_deafen(int sn, int level, CHAR_DATA *ch, SpellTarget vo, CastMode mode);				/* Deafen for AP -Detlef */
