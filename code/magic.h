...
// extern void spell_hand_of_vengeance(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_earthquake(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_floating_disc(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_infernal_aid(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_fortitude(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_spiritblade(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_regenerate(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_decoy(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_decay_corpse(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_life_transfer(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_power_word_stun(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_trace(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_flame_scorch(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_soulbind(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_globe_of_darkness(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_drain(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_slave_of_purgatory(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);	/* Spell for Ancient Only -Detlef */
// extern void spell_mental_knife(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);			/* Spell for Kyr's tattoo -Dio */
// extern void spell_unholy_bless(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_confuse(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);				/* Confuse for Outlaw -Detlef */
// extern void spell_scrying(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_nova(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_randomizer(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_dark_shade(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);			/* for ancient --dioxide */
// extern void spell_lightwalk(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_tsunami(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_familiar(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_fire_and_ice(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_lifeline(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_shadowself(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_true_sight(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_guard_call(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_call_slayer(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_acid_spit(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_unholy_fire(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_general_purpose(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_nexus(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
// extern void spell_portal(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_bless(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_continual_light(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_control_weather(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_create_food(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_create_rose(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_create_spring(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_curse(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_dispel_magic(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_fireball(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_faerie_fog(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_gate(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_holy_word(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_identify(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_invis(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_locate_object(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_magic_missile(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_mass_healing(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_mass_invis(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_null(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_poison(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void poison_tick(CHAR_DATA *ch, AFFECT_DATA *af);
void spell_protection(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_remove_curse(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_summon(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
//
void spell_turn_undead(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);

void spell_ventriloquate(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_gas_breath(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_iceball(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_protective_shield(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
int check_sanguine(CHAR_DATA *ch);
void sanguine_blind(CHAR_DATA *ch, CHAR_DATA *victim);
void spell_sanguine_ward(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_consecrate(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_safety(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_blade_barrier(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_talk_to_dead(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_deathspell(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_lifebane(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);

//
// sceptre of heavens...say 'i am the wrath of god'
//
void spell_heavenly_sceptre_frenzy(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);

//
// sceptre of heavens, say 'Feel the force of god'
//
void spell_heavenly_sceptre_fire(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_divine_touch(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_transfer_object(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_hold_person(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);			/* Hold person -Detlef */
void spell_crushing_hand(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
void spell_deafen(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);				/* Deafen for AP -Detlef */
void spell_talismanic_aura(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
...
void spell_colorful(int sn, int level, CHAR_DATA *ch, SpellTarget vo, int target);
